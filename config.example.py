...
# Email 通知設定
EMAIL_CONFIG = {
    "enabled": False,                  # 預設不啟用，需填寫下列資訊並改為 True
    "smtp_server": "smtp.gmail.com",   # SMTP 伺服器
    "smtp_port": 587,                  # SMTP 連接埠
    "sender_email": "your_email@gmail.com",    # 寄件者 Email
    "sender_password": "your_app_password",    # 寄件者應用程式密碼
    "receiver_emails": ["receiver@example.com"], # 收件者列表
    "subject_prefix": "[健保署爬蟲通知]",      # 郵件主旨前綴
}
